...
main() {
    ...
    case "$height" in
    480)
        fmt="bv*[height<=480][vcodec^=av01][tbr<=1200]+ba/b[height<=480]"
        ;;
    720)
        fmt="bv*[height<=720][vcodec^=av01][tbr<=2500]+ba/b[height<=720]"
        ;;
    1080)
        fmt="bv*[height<=1080][vcodec^=av01][tbr<=5000]+ba/b[height<=1080]"
        ;;
    1440)
        fmt="bv*[height<=1440][vcodec^=av01][tbr<=9000]+ba/b[height<=1440]"
        ;;
    2160)
        fmt="bv*[height<=2160][vcodec^=av01][tbr<=18000]+ba/b[height<=2160]"
        ;;
    *)
        fmt="bv*[vcodec^=av01][tbr<=5000]+ba/b"
        ;;
    esac

    local sort_string="res,fps,hdr:12,acodec:opus"
    ...
    echo "  Container  : auto (MKV/WebM preferred)"
