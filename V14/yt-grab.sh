...
main() {
    ...
    case "$height" in
    480)
        fmt="bv*[height<=480][tbr<=1200]+250/b[height<=480]"
        ;;
    720)
        fmt="bv*[height<=720][tbr<=2500]+250/b[height<=720]"
        ;;
    1080)
        fmt="bv*[height<=1080][tbr<=5000]+250/b[height<=1080]"
        ;;
    1440)
        fmt="bv*[height<=1440][tbr<=9000]+250/b[height<=1440]"
        ;;
    2160)
        fmt="bv*[height<=2160][tbr<=18000]+250/b[height<=2160]"
        ;;
    *)
        fmt="bv*+250/b"
        ;;
    ...
    echo "  Audio      : Opus 250 (smaller size)"
