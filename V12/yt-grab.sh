...
main() {
    ...
    case "$height" in
    480)
        fmt="bv*[height<=480][tbr<=1200]+ba/b[height<=480]"
        ;;
    720)
        fmt="bv*[height<=720][tbr<=2500]+ba/b[height<=720]"
        ;;
    1080)
        fmt="bv*[height<=1080][tbr<=5000]+ba/b[height<=1080]"
        ;;
    1440)
        fmt="bv*[height<=1440][tbr<=9000]+ba/b[height<=1440]"
        ;;
    2160)
        fmt="bv*[height<=2160][tbr<=18000]+ba/b[height<=2160]"
        ;;
    *)
        fmt="bv*+ba/b"
        ;;
    ...
    local sort_string="res,fps,hdr:12,vcodec:av01,vcodec:vp9.2,vcodec:vp9,acodec:opus"
